...
class T5ContinualLearner:
    def __init__(self,
        ...
        if freeze_weights: # 凍結除了share layer以外的所有權重，因為except_condition='share'
        ...
        for num, task in enumerate(task_list):
            ...
            if self.get_test_subset:
                ...
                if test_eval_after_every_task:
                    print('__eval test accuracy for all tasks__')
    ...
    # def create_discrete_prompts(self,prompt_list):
